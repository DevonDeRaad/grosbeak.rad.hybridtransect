...
###save plot
## 1. Open a pdf file
#pdf("~/Desktop/grosbeak.breeding.distribution.map.sampling.xx.pdf", width=15, height=20) 
## 2. Create a plot
#color-code separately
...
## 1. Open a pdf file
#pdf("~/Desktop/SD.grosbeak.breeding.distribution.map.sampling.pdf", width=6, height=4) 
## 2. Create a plot
plot(region_boundary_laea, border = "black", lwd=5)
plot(abd_breeding_laea,
     breaks = breaks, col = c("#e6e6e6",brewer.pal(9, 'Reds'),"#450009"), 
