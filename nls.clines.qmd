...
ggplot() +
  ...
  geom_rect(aes(xmin = bootstrap_CI_mtDNA_model[["bootCI"]][1,2], xmax = bootstrap_CI_mtDNA_model[["bootCI"]][1,3], ymin = 1.1, ymax = 1.2), fill = NA, color = "black") + geom_segment(aes(x = summarymtdna$parameters[1,1], y = 1.1, yend = 1.2), color = "black", lwd = 1)
```
...
ggplot() +
  ...
  geom_rect(aes(xmin = bootstrap_CI_mtDNA_model[["bootCI"]][1,2], xmax = bootstrap_CI_mtDNA_model[["bootCI"]][1,3], ymin = 1.34, ymax = 1.44), fill = NA, color = "black") + geom_segment(aes(x = summarymtdna$parameters[1,1], y = 1.34, yend = 1.44), color = "black", lwd = 1)
...
ggplot() +
  ...
  geom_segment(aes(x = bootstrap_CI_mtDNA_model[["bootCI"]][1,2], xend= bootstrap_CI_mtDNA_model[["bootCI"]][1,3], y = 1.3), color = "black", lwd = 1)+
