...
plot(y, breaks = breaks, col = alpha(c("#e6e6e6","#fffdd0","#fffbae","#fff86b","#fff64e",
             "#fff319","#f5e900","#e5da00","#d5cb00","#b4ab00","#878000"),alpha = 0.8),
     maxcell = ncell(abd_breeding_laea),legend = FALSE, add=TRUE)
plot(abd_breeding_laea,
     breaks = breaks, col = alpha(c("#e6e6e6",brewer.pal(9, 'Reds'),"#450009"),alpha=0.8), 
     maxcell = ncell(abd_breeding_laea),
     legend = FALSE,add=TRUE)
plot(region_boundary_laea, border = "black", lwd=5,add=TRUE)
#add sampling points
...
plot(region_boundary_laea, border = "black", lwd=5)
plot(abd_breeding_laea,
     breaks = breaks, col = alpha(c("#e6e6e6",brewer.pal(9, 'Reds'),"#450009"),alpha=1), 
     maxcell = ncell(abd_breeding_laea),
     legend = FALSE,add=TRUE)
plot(y, breaks = breaks, col = alpha(c("#e6e6e6","#fffdd0","#fffbae","#fff86b","#fff64e",
             "#fff319","#f5e900","#e5da00","#d5cb00","#b4ab00","#878000"),alpha = 1),
     maxcell = ncell(abd_breeding_laea),legend = FALSE, add=TRUE)
plot(region_boundary_laea, border = "black", lwd=5,add=TRUE)
#add sampling points
plot(proven, add=TRUE, col="black", bg="white", pch=21, cex=1)
...
###Plot red over yellow with alpha = 0.75
plot(region_boundary_laea, border = "black", lwd=5)
plot(abd_breeding_laea,
...
###Plot red over yellow with alpha = 0.5
plot(region_boundary_laea, border = "black", lwd=5)
plot(abd_breeding_laea,
